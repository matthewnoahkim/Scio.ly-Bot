...
const subtopicOptions = ["Weather Systems", "Clouds", "Precipitation", "Temperature", "Pressure"];
...
function resolveCorrectIndex(question) {
  ...
  console.warn('[meteorology] Could not resolve correct index from answers:', answers);
  return 0;
}
...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('meteorology')
    .setDescription('Get a Meteorology question')
