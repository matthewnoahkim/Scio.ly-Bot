          ...
          if (btn.customId === `check_${question.id || interaction.id}`) {
            ...
            if (isMCQ) {
              ...
              try {
                ...
                console.error('[chemistrylab] FRQ grading error:', err?.response?.status, err?.message);
            ...
            try {
              ...
              console.error('[chemistrylab] Explanation error:', err?.response?.status, err?.message);
              if (err?.response?.status === 429) {
