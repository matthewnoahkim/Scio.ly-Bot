...
const DIVISIONS = ['B'];
const ALLOWED_SUBTOPICS = ["Oceanography","unknown","Chemistry","Nutrients","Climate","Ocean Circulation","Marine Life","Ecosystems","Geology","Ocean Floor Features","Temperature"];
