...
const DIVISIONS = ['B'];
const ALLOWED_SUBTOPICS = ['Rock Types','Metamorphism','Metamorphic','Mineral Properties','Sedimentary Structures','Formation','Igneous','Mineral Identification','unknown','Sedimentary','Rock Formation'];
