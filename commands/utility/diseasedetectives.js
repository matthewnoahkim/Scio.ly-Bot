          ...
          if (btn.customId === `check_${question.id || interaction.id}`) {
            ...
            if (isMCQ) {
              ...
              try {
                ...
                console.error('[diseasedetectives] FRQ grading error:', err?.response?.status, err?.message);
            ...
            try {
              ...
              console.error('[diseasedetectives] Explanation error:', err?.response?.status, err?.message);
              if (err?.response?.status === 429) {
